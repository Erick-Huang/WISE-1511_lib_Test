...
INCLUDE_PATHS += -I.././sfx_api

LIBRARY_PATHS := -L../. 
LIBRARIES := -l:libsigfox_m4thumbOs_advantek.a
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1490459599.73
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1490459599.73
